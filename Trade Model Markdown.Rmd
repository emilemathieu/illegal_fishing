...
###Elasticity Cost
DDetIn   = density(-ElasticityCost, n=iterations, adjust=3,from=0, to=1) #from=E_minC, to=E_maxC
yDetecIN = DDetIn$y
xDetecIN = DDetIn$x
Prior    = density(Cost_elasticity_P, n=iterations, adjust=3, from=0, to=1) #from=E_minC, to=E_maxC) 
Priory   = Prior$y
Priorx   = Prior$x
...
Priory   = Prior$y
Priorx   = Prior$x
plot(xDetecIN,yDetecIN, type="l",xlab="Total Landings",ylab="Probability Density", col="blue")
lines(Priorx,Priory)
